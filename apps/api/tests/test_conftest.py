...
def test_validate_accepts_qteria_test():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/qteria_test", "CI": ""}, clear=False):
...
def test_validate_accepts_suffix_test_underscore():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/myapp_test", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_accepts_suffix_test_hyphen():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/myapp-test", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_rejects_neondb():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/neondb", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_rejects_postgres():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/postgres", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_rejects_production():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/production", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_rejects_malformed_url_no_database():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/", "CI": ""}, clear=False):
        from conftest import _validate_test_database_url
...
def test_validate_ci_environment_with_test_database():
    ...
    with patch.dict(
        os.environ, {"DATABASE_URL": "postgresql://user:pass@neon.tech/qteria-test", "CI": "true"}, clear=False
    ):
        from conftest import _validate_test_database_url
...
def test_validate_ci_environment_still_rejects_production():
    ...
    with patch.dict(os.environ, {"DATABASE_URL": "postgresql://user:pass@host/production", "CI": "true"}, clear=False):
        from conftest import _validate_test_database_url
...
def test_password_masking_in_production_error():
    ...
    with patch.dict(
        os.environ, {"DATABASE_URL": "postgresql://user:secretpass123@host/production", "CI": ""}, clear=False
    ):
        from conftest import _validate_test_database_url
...
def test_accepts_url_with_query_params():
    ...
    with patch.dict(
        os.environ,
        {"DATABASE_URL": "postgresql://user:pass@host/qteria_test?sslmode=require&connect_timeout=10", "CI": ""},
        clear=False,
    ):
        from conftest import _validate_test_database_url
