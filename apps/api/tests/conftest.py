...
def pytest_sessionstart(session):
    ...
    This seeding is IDEMPOTENT - it can be run multiple times without errors:
    - Uses PostgreSQL ON CONFLICT DO NOTHING for upsert behavior
    - Handles empty database, partial data, and fully seeded database scenarios
    - No need to manually clear test data between runs
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("🌱 Seeding test database (pytest_sessionstart)")
        print("=" * 60)
        seed_test_data()
        print("=" * 60)
        print()
