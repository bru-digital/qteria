    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-8 space-y-8 print:shadow-none">
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              Qteria (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) provides an AI-powered
              document validation platform designed for Testing, Inspection, and Certification (TIC)
              organizations. The Service enables you to create validation workflows, upload
              documents, and receive evidence-based AI assessments.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 mt-4">
              <p className="text-base text-gray-800 leading-relaxed font-semibold">
                IMPORTANT: Qteria provides pre-assessment validation only. AI results are not final
                certification decisions. Final certification must be performed by qualified
                professionals.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Professional Tier:</strong> $30,000/year (flat fee, unlimited assessments)
              </li>
              <li>
                <strong>Enterprise Tier:</strong> Custom pricing for custom features and
                integrations
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li>
                <strong>30-Day Satisfaction Guarantee:</strong> Pro-rata refund if canceled within
                first 30 days
              </li>
              <li>
                <strong>No Mid-Year Cancellation:</strong> No refunds after 30 days (annual
                commitment applies)
              </li>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mt-4">
              Organization administrators are responsible for managing user accounts (Process
              Managers, Project Handlers) and ensuring compliance with these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              You may use Qteria for document validation related to certification and compliance
              workflows as intended by the platform.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.2 Prohibited Activities</h3>
            <p className="text-base text-gray-700 leading-relaxed mb-4">You may NOT:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              Violation of this policy may result in account suspension or termination without
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              You retain ownership of all uploaded documents, workflow definitions, and assessment
              results. We claim no ownership rights over your content.
            </p>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Qteria owns all rights to the platform code, AI models, algorithms, design, and
              branding. These Terms do not grant you any ownership or license to our intellectual
              property beyond the right to use the Service.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.3 Limited License</h3>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              You grant Qteria a limited, non-exclusive license to process your documents for the
              sole purpose of providing validation services. This license terminates when you delete
              documents or close your account.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.4 Zero AI Training</h3>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
              <p className="text-base text-gray-800 leading-relaxed">
                <strong>Important:</strong> We will NOT use your documents to train AI models. We
                maintain zero-retention agreements with our AI providers (Anthropic Claude). Your
                documents are processed ephemally and never stored by our AI vendors.
              </p>
            </div>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              Any feedback, suggestions, or feature requests you provide become the property of
              Qteria and may be used to improve the Service without compensation to you.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Target Uptime:</strong> 99.5% monthly uptime (approximately 3.6 hours of
                allowed downtime per month)
              </li>
              <li>
                <strong>Planned Maintenance:</strong> Announced at least 48 hours in advance,
                scheduled during low-usage windows
              </li>
              <li>
                <strong>Emergency Maintenance:</strong> May occur without notice for critical
                security issues
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Target Processing Time:</strong> P95 &lt;10 minutes for typical assessments
              </li>
              <li>
                <strong>Best-Effort Basis:</strong> Processing times are targets, not guarantees
              </li>
              <li>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Critical Issues</strong> (service down): &lt;4 hours response time
              </li>
              <li>
                <strong>High Priority</strong> (feature broken): &lt;24 hours response time
              </li>
              <li>
                <strong>Normal Priority</strong> (general inquiries): &lt;48 hours response time
              </li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mb-3">6.4 SLA Credits</h3>
            <p className="text-base text-gray-700 leading-relaxed">
              If monthly uptime falls below 99.5%, you will receive a 10% monthly credit on your
              next invoice. SLA credits are your sole remedy for service downtime.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Encryption at Rest:</strong> AES-256 encryption for stored documents
              </li>
              <li>
                <strong>Encryption in Transit:</strong> TLS 1.3 for all data transmission
              </li>
              <li>
                <strong>Multi-Tenancy Isolation:</strong> Organization-level data separation
              </li>
              <li>
                <strong>Role-Based Access Control:</strong> User permissions enforced at all levels
              </li>
              <li>
                <strong>Audit Logging:</strong> Comprehensive tracking of all user actions
              </li>
              <li>
                <strong>SOC2 Type II Certification:</strong> Target Q3 2026
              </li>
            </ul>
            <p className="text-base text-gray-700 leading-relaxed">
              You have the right to request annual security questionnaires and SOC2 reports once
              available.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>Your Confidential Information:</strong> All uploaded documents, workflow
                definitions, and assessment results
              </li>
              <li>
                <strong>Our Confidential Information:</strong> Platform source code, AI models,
                algorithms, and business information
              </li>
            </ul>
            <p className="text-base text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Qteria provides the Service with reasonable skill and care, consistent with industry
              standards for B2B SaaS platforms.
            </p>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              You acknowledge that final certification decisions must be made by qualified
              professionals. Qteria is not liable for certification outcomes based on AI validation
              results.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Qteria&apos;s total liability for any claims arising from these Terms or the Service
              is limited to the fees you paid in the 12 months prior to the claim.
            </p>
            ...
            <div className="bg-gray-50 border-l-4 border-gray-400 p-4 mb-4">
              <p className="text-base text-gray-800 leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, QTERIA SHALL NOT BE LIABLE FOR INDIRECT,
                CONSEQUENTIAL, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFITS,
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              <li>
                <strong>For Cause:</strong> Non-payment, breach of Terms, or illegal activity
                (15-day cure period provided)
              </li>
              <li>
                <strong>Without Cause:</strong> With 90-day notice (we will provide exit assistance)
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <li>
                We will delete your data 30 days after termination (except audit logs retained for 7
                years)
              </li>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              ...
              updated Terms. If you disagree with changes, you may terminate your account before the
              changes take effect.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              These Terms are governed by the laws of [TO BE DETERMINED - requires legal counsel to
              specify jurisdiction based on company registration and target market].
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 ml-4">
              ...
              <li>
                If negotiation fails, disputes will be resolved through binding arbitration or
                courts in [jurisdiction to be specified]
              </li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mb-3">13.3 Jurisdiction</h3>
            <p className="text-base text-gray-700 leading-relaxed">
              You consent to the exclusive jurisdiction of courts in [TO BE DETERMINED] for any
              legal proceedings.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              ...
              (natural disasters, wars, pandemics, government actions, internet outages, etc.).
            </p>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              ...
              you and Qteria and supersede all prior agreements or understandings.
            </p>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              These Terms are solely between you and Qteria. No third party has rights under these
              Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded">
              <p className="text-base text-gray-800">
                <strong>Email:</strong>{' '}
                <a href="mailto:legal@qteria.com" className="text-blue-500 hover:underline">
                  legal@qteria.com
                </a>
                <br />
                <strong>Company:</strong> Qteria
                <br />
        ...
        <div className="mt-8 text-center space-y-2">
          <Link href="/" className="text-blue-500 hover:text-blue-600 font-medium inline-block">
            ← Back to Home
          </Link>
