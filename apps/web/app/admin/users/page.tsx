        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              User management functionality will be implemented in a future release. This page will
              allow you to invite, manage, and deactivate users in your organization.
            </p>
          </div>
        </div>
      </main>
